...
<html>
    ...
    <script>
        ...
        function search_filter(tag_filter){
            tagfilter = document.querySelector('tag_filter');
            location.href="filtered_home.php?tag_filter="+tag_filter+"&";
        }
    ...
    <body>
        ...
        <div class="p-5">
            ...
            <input type="text" name="tag_filter" id="tag_filter" class="tag_filter" style="margin-top:20px; width:200px; border-radius:20px; border:1px solid grey">
            <input style="float:right; width:200px; padding:10px; border-radius:20px; margin-left:20px; border:none; background-color:blue; color:white;" value="Search" type="button" onclick="search_filter()">
